...
async function repaymentTxn(tx) {
    ...
    let repaymentRegistry = await getAssetRegistry('org.p2plending.model.Repayment');
    let factory = getFactory();
    let asset = factory.newResource('org.p2plending.model', 'Repayment', tx.transactionId);
    asset.lend = factory.newResource('org.p2plending.model', 'Lend', tx.lendId);
    await repaymentRegistry.add(asset);
